...
### [3] [Healing of topological defects while crystallizing nanocrystals](https://arxiv.org/abs/2604.21105)
...
### [4] [Controlled Manipulation of Intermediate State in a Type-I Superconductor](https://arxiv.org/abs/2604.21499)
...
### [5] [Pairing mechanism and superconductivity in 1313 phase La$_3$Ni$_2$O$_7$](https://arxiv.org/abs/2604.21533)
...
### [6] [Superconductivity induced by altermagnetic spin fluctuations in high-pressure MnB$_4$](https://arxiv.org/abs/2604.21561)
...
### [7] [Two-gap to Single-gap Transition and Two-dome-like Superconductivity in Alkali-Metal Intercalated Bilayer PdTe2](https://arxiv.org/abs/2604.21635)
...
### [8] [Effect of Mn Substitution on Superconductivity in PrFeAs(O,F): Role of Magnetic Impurities](https://arxiv.org/abs/2604.21684)
...
### [9] [$3d_{z^2}$ orbital delocalization and magnetic collapse in superconducting (La,Pr)$_3$Ni$_2$O$_{7-δ}$ films](https://arxiv.org/abs/2604.21899)
...
### [22] [Giant spontaneous Kerr effect reveals the defect origin of macroscopic time-reversal symmetry breaking in altermagnetic MnTe](https://arxiv.org/abs/2604.21021)
...
### [23] [Studying 3D O(N) Surface CFT on the Fuzzy Sphere](https://arxiv.org/abs/2604.21091)
...
### [24] [BCS-BEC crossover of polaritonic condensates in mass-imbalanced semimetal/semiconductor microcavities](https://arxiv.org/abs/2604.21244)
...
### [25] [Condensate states in Fermi and Bose-Hubbard ladders](https://arxiv.org/abs/2604.21296)
...
### [26] [$η$-pairing in a two-band model of spinless fermions](https://arxiv.org/abs/2604.21318)
*Igor N. Karnaukhov*
...
### [27] [Pressure-Tuned Competing Electronic States in Layered Tellurides](https://arxiv.org/abs/2604.21336)
...
### [28] [Decomposing Fractional Quantum Hall Wave Functions via Operator Contraction Multiplication](https://arxiv.org/abs/2604.21434)
...
### [29] [Symplectic symmetry of quadratic-band-touching Hamiltonians in two dimensions](https://arxiv.org/abs/2604.21524)
...
### [30] [Dynamical mean-field theory for dense spin systems at finite temperature](https://arxiv.org/abs/2604.21563)
...
### [31] [High-Accuracy Numerical Solutions of Particle Motion in Static Magnetic Fields](https://arxiv.org/abs/2604.20876)
...
### [32] [Modulation Effects of Atmospheric Environmental Conditions on Mesoscale Convective Systems over Tropical Oceans](https://arxiv.org/abs/2604.21023)
...
### [33] [Two-Way Feedback Mechanisms between the Madden-Julian Oscillation and Mesoscale Convective Systems](https://arxiv.org/abs/2604.21038)
*Haobo Yang,Qiu Yang*
...
### [34] [A High-Order Nodal Galerkin Formulation for the Müller Equation: Bypassing Divergence Conformity via Kernel Cancellation](https://arxiv.org/abs/2604.21181)
*Yao Luo*
...
### [35] [Enabling Biomolecular Simulations with Neural Network Potentials in GROMACS](https://arxiv.org/abs/2604.21441)
...
### [36] [A Thin Sheet Volume Integral Equation Solver for Simulation of Bianisotropic Metasurfaces](https://arxiv.org/abs/2604.21474)
...
### [37] [Double circular dichroism high harmonic spectroscopy: An ultrafast probe for topological photocurrents](https://arxiv.org/abs/2604.21121)
...
### [38] [Physics of Computation and Behavior in Plants](https://arxiv.org/abs/2604.21763)
*Yasmine Meroz*
...
### [39] [KinetiDiff: Docking-Guided Diffusion for De Novo ACVR1 Inhibitor Design in Fibrodysplasia Ossificans Progressiva](https://arxiv.org/abs/2604.20886)
*Aaryan Patel*
...
### [40] [Engineering molecular potential energy surfaces using magnetic cavity quantum electrodynamics](https://arxiv.org/abs/2604.20969)
...
### [41] [Chaos Gated Tunneling Drives Molecular Reactivity in Astrophysical Environments](https://arxiv.org/abs/2604.21005)
...
### [42] [Birth, Death, and Replication at Surfaces: Universal Laws of Autocatalytic Dynamics](https://arxiv.org/abs/2604.21586)
*Denis S. Grebenkov*
...
### [43] [Molecular dynamics simulations of Nafion thin films at a platinum catalyst surface: Correlating structure with charging behaviour](https://arxiv.org/abs/2604.21773)
...
### [44] [Predicting Scale-Up of Metal-Organic Framework Syntheses with Large Language Models](https://arxiv.org/abs/2604.20899)
...
### [45] [Evolution of the Saddle Point in Antimony Telluride Homologous Superlattices](https://arxiv.org/abs/2604.21037)
...
### [46] [Expanding the extreme-k dielectric materials space through physics-validated generative reasoning](https://arxiv.org/abs/2604.21068)
...
### [47] [Accelerating point defect simulations using data-driven and machine learning approaches](https://arxiv.org/abs/2604.21069)
...
### [48] [Generative Discovery of Magnetic Insulators under Competing Physical Constraints](https://arxiv.org/abs/2604.21073)
...
### [49] [Nearly Complete Charge--Spin Conversion via Strain-Eliminated Fermi Pockets in a $d$-Wave Altermagnet](https://arxiv.org/abs/2604.21779)
...
### [50] [Neutron and X-ray Diffraction Reveal the Limits of Long-Range Machine Learning Potentials for Medium-Range Order in Silica Glass](https://arxiv.org/abs/2604.21222)
...
### [51] [Data-Driven Thermal and Mechanical Modeling of Defective Covalent Organic Frameworks](https://arxiv.org/abs/2604.21494)
...
### [52] [Velocity-field characteristics and device performance in nanoscale amorphous oxide Thin-Film-Transistors](https://arxiv.org/abs/2604.21225)
...
### [53] [Electrically switchable vacancy state revealed by in-operando positron experiments](https://arxiv.org/abs/2604.21283)
...
### [54] [Intertwined charge density wave, tunable anti-dome superconductivity, and topological states in kagome metal VSn](https://arxiv.org/abs/2604.21488)
...
### [55] [Room-temperature third-order nonlinear anomalous Hall effect in ferromagnetic metal Fe3GaTe2](https://arxiv.org/abs/2604.21285)
...
### [56] [Single-crystal growth and magnetic, magnetoelectric, and optical properties of ferroaxial-type SrMn$_2$Ni$_6$Te$_3$O$_{18}$](https://arxiv.org/abs/2604.21460)
...
### [57] [Navigating Order-(Dis)Order Family Trees via Group-Subgroup Transitions](https://arxiv.org/abs/2604.21386)
...
### [58] [Identifying Oriented Spin Space Groups and Related Physical Properties Using an Online Platform FINDSPINGROUP](https://arxiv.org/abs/2604.21397)
...
### [59] [GEWUM: General Exploration Workflow for the Utopia of Materials: A Unified Platform for Automated Structure Generation, Selection, and Validation](https://arxiv.org/abs/2604.21401)
...
### [60] [Emergence of a non-bulk hexagonal Fe$_2$S$_2$ single layer via phase transformation](https://arxiv.org/abs/2604.21613)
...
### [61] [Neural surrogates for crystal growth dynamics with variable supersaturation: explicit vs. implicit conditioning](https://arxiv.org/abs/2604.21753)
...
### [62] [Self-consistent evaluation of the Berry connection for Wannier functions](https://arxiv.org/abs/2604.21660)
...
### [63] [Electronic and Vibrational Properties of On-Surface Synthesized Gulf-Edged Chiral Graphene Nanoribbons](https://arxiv.org/abs/2604.21796)
